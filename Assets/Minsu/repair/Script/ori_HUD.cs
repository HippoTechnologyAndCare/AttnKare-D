...
{
    public class ori_HUD : MonoBehaviour
    {
        /**************************************************************************
        // Common UI Constant
        ***************************************************************************/
        ...
        ******************************************/
        ...
        void PlayStart()
        {
            ...
            StartCoroutine(
                ...
                m_canvasHMD,
                ori_Guide.HUD_REPORT.PLAYED_HOWTO
            ));
            */
        ...
        *************************************************/
        public void PlaySceneTimeOut()
        {
            ...
            StartCoroutine(
                ...
                null,  //Text없음
                null,  //Canvas없음
                ori_Guide.HUD_REPORT.PLAYED_TIMEOUT)
            );
            */
        }
        /************************************************
        ...
        *************************************************/
        public void PlayWellDone()
        {
            StartCoroutine(
                ...
                null,  //Text없음
                null,  //Canvas없음
                ori_Guide.HUD_REPORT.PLAYED_WELLDONE)
            );
        }
        /************************************************
        // HMD안내- "이동합니다 " 전시    
        *************************************************/
        ...
        public void PlayMoving()
        {
            StartCoroutine(
                ...
                m_canvasHMD,
                ori_Guide.HUD_REPORT.PLAYED_MOVING)
            );
        }
        ...
        */
            ...
            //m_Guide.HudReport(ori_Guide.HUD_REPORT.PLAYED_TIMEOUT);
        ...
        public void PlayWarning()
        {
            StartCoroutine(
                ...
                m_goReallyWant,
                m_canvasFin,
                ori_Guide.HUD_REPORT.NONE) //보고할 메세지 없음
            );
        }
        ...
        ***************************************************************************/
        ...
        IEnumerator PlaySoundText(AudioSource audioSource, AudioClip audioClip, GameObject goText, Canvas canvas, ori_Guide.HUD_REPORT eReport)
        {
            ...
            //if (eReport != ori_Guide.HUD_REPORT.NONE) m_Guide.HudReport(eReport); // Guide에게 Report할게 있으면 Report
        }
        ...
        {
            //m_goLeftFindNote.SetActive ( (m_InputBridge.LeftTrigger>0.5f) && ori_Guide.m_eState == ori_Guide.STATE.FIND);
            //m_goLeftCleanNote.SetActive( (m_InputBridge.LeftTrigger>0.5f) && ori_Guide.m_eState == ori_Guide.STATE.ARRANGE);       
            m_goRightNotGrabble.SetActive((m_InputBridge.RightGrip > 0.5f) && ori_Guide.m_eState == ori_Guide.STATE.INTRO);
        }

        /**************************************************************************
        // Monobehavier
        ***************************************************************************/
        public ori_Guide m_Guide;//for Report
